...
export default function Scanner() {
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 h-full flex flex-col">
      ...
      <p className="text-base text-gray-600 mb-6">
        Upload a photo of your Pokémon card for instant identification and pricing
      </p>

      {/* Upload Section */}
      <div className="flex-1 m-8 border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-purple-400 transition-colors flex flex-col justify-center">
        <div className="text-5xl mb-3">📷</div>
        ...
        <button className="bg-gray-900 text-white px-6 py-2 text-sm w-[25%] rounded-lg font-medium hover:bg-gray-800 transition-colors self-center items-center gap-2 cursor-pointer">
          <span>⬆️</span> Upload Image
        </button>
