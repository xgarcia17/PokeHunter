    ...
    <nav className="bg-white shadow-sm border-b border-gray-200 flex-shrink-0">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap md:flex-nowrap items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12">
        ...
        <div className="flex gap-6 text-sm mx-auto">
          <button className="flex-shrink-0 flex items-center gap-2 px-3 py-2 bg-transparent text-gray-700 rounded-lg font-medium hover:bg-gray-100 hover:shadow-lg transition cursor-pointer">
            📷 Scan
          </button>
          <button className="flex-shrink-0 flex items-center gap-2 px-3 py-2 rounded-lg bg-transparent text-gray-700 font-medium hover:bg-gray-100 hover:shadow-lg transition cursor-pointer">
            📋 Collection
          </button>
          <button className="flex-shrink-0 flex items-center gap-2 px-3 py-2 rounded-lg bg-transparent text-gray-700 font-medium hover:bg-gray-100 hover:shadow-lg transition cursor-pointer">
            📈 Pricing
