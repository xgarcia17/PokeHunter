    ...
    <nav className="bg-white shadow-sm border-b border-gray-200 flex-shrink-0">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap md:flex-nowrap items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12">
        ...
        <div className="flex gap-6 text-sm mx-auto">
          <button className={MINI_BUTTON_CLASSNAME}>📷 Scan</button>
          <button className={MINI_BUTTON_CLASSNAME}>📋 Collection</button>
          <button className={MINI_BUTTON_CLASSNAME}>📈 Pricing</button>
          <button className={MINI_BUTTON_CLASSNAME}>✨ Recommendations</button>
        </div>
      </div>
    </nav>
  );
